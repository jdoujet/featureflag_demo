 ...
 * */var KameleoonClient=/*#__PURE__*/function(a){function b(a,d){_classCallCheck(this,b);var e=new _storage.StorageConstructor,f=new _eventSource.EventSourceConstructor,g=new _requester.RequestDispatcher;return c.call(this,{siteCode:a,configuration:d,internalConfiguration:{externalStorage:e,externalEventSource:f,externalRequestDispatcher:g,externalPackageInfo:{type:_javascriptSdkCore.SdkLanguageType.JAVASCRIPT,version:"1.7.3"}}})}/**
   ...
   */_inherits(b,a);var c=_createSuper(b);return _createClass(b,[{key:"initialize",value:function(){function a(){return c.apply(this,arguments)}var c=_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function c(a){return _regeneratorRuntime().wrap(function d(c){for(;1;)switch(c.prev=c.next){case 0:return c.abrupt("return",_get(_getPrototypeOf(b.prototype),"initialize",this).call(this,a));case 1:case"end":return c.stop();}},c,this)}));return a}()}]),b}(_javascriptSdkCore.KameleoonCore);exports.KameleoonClient=KameleoonClient;
